...
class ViewController4: UIViewController, UIScrollViewDelegate {
...
"""
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        scrollView.backgroundColor = .systemCyan.withAlphaComponent(scrollView.contentOffset.y / screenHeight)
